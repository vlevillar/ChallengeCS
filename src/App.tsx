...
const formSequence = ['start', 'second', 'third', 'fourth', 'fifth', 'final'] as const;
...
function App() {
  ...
  return (
    <UserProvider>
      ...
      <Intro isFinalScreen={isFinalScreen} currentIndex={currentIndex} totalSteps={totalSteps}>
        <AnimatePresence mode='wait'>
          ...
          >
            ...
            {currentForm === 'second' && <SecondForm onBack={handlePreviousForm} onNext={handleNextForm} />}
            {currentForm === 'third' && <ThirdForm onBack={handlePreviousForm} onNext={handleNextForm} />}
            {currentForm === 'fourth' && <FourthForm onBack={handlePreviousForm} onNext={handleNextForm} />}
            {currentForm === 'fifth' && <FifthForm onBack={handlePreviousForm} onNext={handleNextForm} />}
